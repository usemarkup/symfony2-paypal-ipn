    ...
    public function getConfigTreeBuilder()
    {
        ...
        $rootNode
            ->children()
                ...
                ->end()
                ->booleanNode('sandbox_debug')
                    ->defaultValue(true)
                ->end()
                ->scalarNode('sandbox_response')
                    ->defaultValue(null)
                ->end()
                ->scalarNode('sandbox_pdttoken')
                    ->defaultValue(null)
                ->end()
                ->variableNode('sandbox_pdtresponse')
                    ->defaultValue(null)
                ->end()
                ->scalarNode('sandbox_proxy')
                    ->defaultValue(null)
                ->end()
                ->arrayNode('email')
                    ->prototype('scalar')->end()
                ->end()
                ->arrayNode('sandbox_email')
                    ->prototype('scalar')->end()
                ->end()
            ->end()
        ->end();
